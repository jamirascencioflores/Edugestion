...
public class ExcelHelper {
    ...
    // Validar que el archivo sea efectivamente de formato Excel .xlsx
    public static boolean esFormatoExcel(MultipartFile file) {
        return TYPE.equals(file.getContentType());
    }

    // Obtener valor como String de cualquier celda
    ...
    // Comprobar si una fila está completamente vacía
