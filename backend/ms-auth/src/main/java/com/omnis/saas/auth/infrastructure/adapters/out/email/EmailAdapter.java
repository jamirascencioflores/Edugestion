...
public class EmailAdapter implements EmailServicePort {
    ...
    @Async
    @Override
    public void enviarInvitacion(String destinatario, String nombre, String token, String subdominio) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");

            helper.setFrom("soporte@edugestion.io");
            helper.setTo(destinatario);
            helper.setSubject("Bienvenido a EduGestión - Activa tu cuenta");

            // 🚀 Construimos la URL dinámica usando el subdominio del colegio
            String urlActivacion = String.format("http://%s.localhost:5173/setup-password?token=%s", subdominio, token);
            ...
            String html = """
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
                    ...
                    <div style="padding: 30px; background-color: #ffffff; color: #333333;">
                        ...
                        <p style="font-size: 16px; line-height: 1.5;">Has sido registrado en nuestra plataforma. Para completar tu configuración y acceder a tu panel, establece tu contraseña haciendo clic abajo:</p>
    ...
    public void enviarCorreoRecuperacion(String destinatario, String nombre, String token) {
        try {
            ...
            helper.setFrom("jamirascencio1@gmail.com");
            helper.setTo(destinatario);
