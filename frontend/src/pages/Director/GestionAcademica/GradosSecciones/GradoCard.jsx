// src/pages/Director/GestionAcademica/GradosSecciones/GradoCard.jsx
...
export default function GradoCard({
  ...
  return (
    <div
      className={`bg-white dark:bg-slate-800 rounded-2xl border transition-all duration-200 shadow-xs overflow-hidden flex flex-col justify-between ${
        grado.estado
    ...
    >
        ...
        <div className="px-4 sm:px-5 py-3 space-y-2.5">
          {secciones.length === 0 ? (
            ...
            secciones.map((sec) => (
              <div
                key={sec.id}
                className={`flex flex-col sm:flex-row sm:items-center justify-between p-3 rounded-xl border gap-2 transition-all duration-200 ${
                  sec.estado
              ...
              >
                ...
                <div className="flex items-center gap-3 min-w-0">
                  <div
                    className={`w-8 h-8 rounded-lg flex items-center justify-center font-semibold text-xs shrink-0 transition-colors ${
                      sec.estado
                ...
                {/* Badges y Acciones */}
                <div className="flex items-center justify-between sm:justify-end gap-1.5 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-200/60 dark:border-slate-700/60">
                  <span
      ...
      <div className="p-4 pt-2 border-t border-slate-100 dark:border-slate-700/60">
        <button
          ...
          className="w-full py-2 px-3 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-700/50 text-slate-600 dark:text-slate-300 text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors"
        >
